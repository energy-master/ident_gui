...
<!-- 
    ...
    <div id="user-data-window-holder" style="display:block;"><div id="user-data-window" ></div></div>
    <div id="signature-data-window-holder" style="display:none;"><div id="signature-data-window" ></div></div>

    <div id="filter-data-window-holder" style="display:none;"><div id="filter-data-window" ></div></div>
